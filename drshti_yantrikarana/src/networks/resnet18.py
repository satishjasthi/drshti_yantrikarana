...
About: script to create resnet18 in pure tensorflow
...
#         """Convolution block"""
# 
#         # create a variable scope for conv block
#         with tf.compat.v1.variable_scope(name):
# 
#             # total number of neurons in conv output
#             n = filter_size * filter_size * out_filters
# 
#             # since kernel is trainable create it as a variable
...
#         """Residual block with 2 sub layers."""
# 
...
class ResNet(object):
  ...
  def _build_train_op(self):
    ...
    self.momentum_rate = tf.constant(self.hps.momentum_rate, tf.float32)
    tf.summary.scalar('learning_rate', self.lrn_rate)
    tf.summary.scalar('momentum_rate', self.momentum_rate)
    ...
    if self.hps.optimizer == 'sgd':
      ...
      optimizer = tf.compat.v1.train.MomentumOptimizer(self.lrn_rate, self.momentum_rate)
  ...
  def _fully_connected(self, x, out_dim):
    ...
    w = tf.compat.v1.get_variable(
        ...
        initializer=tf.compat.v1.initializers.uniform_unit_scaling(factor=1.0))
